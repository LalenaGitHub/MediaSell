...
INSERT INTO "Artikel" VALUES(5,5,'Franz Urban','Java Videokurs',99.99,'false',600,21);
...
CREATE VIEW "KKA" AS    select  r.kassenvorgangID, r.datum, r.storno,  a.artikelNr, r.anzahl, a.author, a.titel, a.preis, a.status, a.bestand, a.warengruppe,
k.kundeNr, k.vorname, k.nachname, k.strasse, k.hausnr, k.plz, k.stadt, k.email, k.telefonNr, k.zahlungsart, k.status
